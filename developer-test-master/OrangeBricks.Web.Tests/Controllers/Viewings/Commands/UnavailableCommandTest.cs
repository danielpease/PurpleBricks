...
namespace OrangeBricks.Web.Tests.Controllers.Viewings
{
    [TestFixture]
    public class UnavailableCommandTest
    {
        private UnavailableCommandHandler _handler;
        ...
        public void SetUp()
        {
            ...
            _handler = new UnavailableCommandHandler(_context);
        }

        [Test]
        public void HandleShouldUpdateToViewingToUnavailable()
        {
            // Arrange
            var command = new UnavailableCommand
            {
                ViewingId = 1,
                PropertyId = 1
            };
            ...
            Assert.True(viewing.Status == ViewStatus.Unavailable);
        }
    }
}
